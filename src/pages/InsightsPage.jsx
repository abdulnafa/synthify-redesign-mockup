...
export default function InsightsPage() {
  return (
    <>
      <section className="page-hero page-hero--compact"><div className="container page-hero__compact-grid"><h1>Useful thinking for better people decisions.</h1><p>Regional updates and practical perspectives from the Synthify team.</p></div></section>
